...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Status** {}<br>} | object |  | This type describes the status and health of a resource and its children. See the *[Resource](http://redfish.dmtf.org/schemas/v1/Resource.json)* schema for details on this property. |
