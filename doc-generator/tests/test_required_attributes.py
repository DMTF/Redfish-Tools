...
def test_required_attribute_collection(mockRequest):
    ...
    eventDefinitions = eventData['definitions']
    eventRecordProps = eventDefinitions['EventRecord']['properties']
    assert eventRecordProps['EventType']['prop_required'] is True
    assert eventRecordProps['MessageId']['prop_required'] is True
    assert eventRecordProps['Severity']['prop_required'] is False
    assert eventRecordProps['Oem']['prop_required'] is False
